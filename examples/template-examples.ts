...
console.log('\n[LIST] Example 1: List All Templates\n');
const templates = listTemplates();
templates.forEach((template) => {
  console.log(`  [DOC] ${template.name}`);
...
console.log('='.repeat(80));
console.log('\n[EDIT] Example 2: Render Changelog Template\n');
try {
  ...
  console.log('[OK] Successfully rendered changelog template');
...
console.log('\n' + '='.repeat(80));
console.log('\n[EDIT] Example 3: Render Meeting Notes Template\n');
try {
  ...
  console.log('[OK] Successfully rendered meeting notes template');
...
console.log('\n' + '='.repeat(80));
console.log('\n[EDIT] Example 4: Render Technical Documentation Template\n');
try {
  ...
  console.log('[OK] Successfully rendered technical documentation template');
  console.log('\nFirst 400 characters:');
  console.log('-'.repeat(80));
...
console.log('\n' + '='.repeat(80));
console.log('\n[ERROR] Example 5: Error Handling - Missing Variables\n');
try {
  ...
  if (error instanceof Error) {
    console.log('[OK] Correctly caught error:');
...
console.log('\n' + '='.repeat(80));
console.log('\n[ERROR] Example 6: Error Handling - Template Not Found\n');
try {
...
console.log('\n' + '='.repeat(80));
console.log('\n[SEARCH] Example 7: Extract Variables from Content\n');
...
console.log('\n' + '='.repeat(80));
console.log('\n[CUSTOM] Example 8: Create Custom Template\n');
...
console.log(`  Validation: ${validateTemplate(customTemplate) ? '[OK] Valid' : '[ERROR] Invalid'}`);

// Example 9: Render project update
console.log('\n' + '='.repeat(80));
console.log('\n[EDIT] Example 9: Render Project Update Template\n');
try {
  ...
  console.log('[OK] Successfully rendered project update template');
...
console.log('\n' + '='.repeat(80));
console.log('\n[SEARCH] Example 10: Get Template Details\n');
...
if (changelogTemplate) {
  ...
  console.log(
    `  Validation: ${validateTemplate(changelogTemplate) ? '[OK] Valid' : '[ERROR] Invalid'}`
  );
}
