...
console.log(
  'Match:',
  result1 === 'Development Sessions/test-project/test-note.md' ? '[OK]' : '[ERROR]'
);
console.log();
...
console.log('Match:', result2 === 'Projects/my-app/docs/api-reference.md' ? '[OK]' : '[ERROR]');
console.log();
...
console.log('Match:', result3 === 'Open Source/awesome-lib/README.md' ? '[OK]' : '[ERROR]');
console.log();
...
try {
  ...
  console.log('[ERROR] FAILED: Should have thrown an error');
} catch (error) {
  console.log('[OK] PASSED: Correctly rejected directory traversal');
...
try {
  ...
  console.log('[OK] PASSED: Correctly rejected absolute path');
  console.log('Error:', (error as Error).message);
}
console.log();
