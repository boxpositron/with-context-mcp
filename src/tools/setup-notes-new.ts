...
/**
 * Enhanced setup notes handler with intelligent analysis
 */
export async function setupNotesEnhanced(args: SetupNotesArgs): Promise<string> {
...
export const setupNotesEnhancedSchema = {
  name: 'setup_notes_enhanced',
  description:
    'Intelligently analyze repository documentation and setup optimal .withcontextconfig.jsonc. ' +
    'Scans the repo, validates README, and recommends documentation architecture based on best practices.',
  inputSchema: {
    type: 'object',
    properties: {
      project_root: {
